...
--
-- Host: localhost:3306
-- Generation Time: Jul 16, 2019 at 03:40 AM
...
--
ALTER TABLE `amenities`
  ADD CONSTRAINT `amenities_ibfk_1` FOREIGN KEY (`listingID`) REFERENCES `listing` (`listingID`);

--
-- Constraints for table `calendar`
--
ALTER TABLE `calendar`
  ADD CONSTRAINT `calendar_ibfk_1` FOREIGN KEY (`listingID`) REFERENCES `listing` (`listingID`);
...
--
ALTER TABLE `reservations`
  ADD CONSTRAINT `reservations_ibfk_1` FOREIGN KEY (`listingID`) REFERENCES `listing` (`listingID`);
COMMIT;
