...
public class queries {
	...
	public static ArrayList<HashMap<String, String>> startFilter(Connection connection, boolean postal,
			String postalValue, boolean distance, double km, double lat, double lng, boolean address,
			String searchAddress, boolean temporal, Date start, Date end, boolean price, double priceL, double priceH,
			boolean amenities, String searchAmenities, int rankPrice) throws SQLException {
		...
		if (rankPrice > 0) {
			...
			if (rankPrice == 1) {
				Comparator<HashMap<String, String>> c = (h1, h2) -> {
					return h1.get("price").compareTo(h2.get("price"));
				};
				data.sort(c);
			} else if (rankPrice == 2) {

				Comparator<HashMap<String, String>> c = (h1, h2) -> {
					return h2.get("price").compareTo(h1.get("price"));
				};
				data.sort(c);
	...
	public static ArrayList<HashMap<String, String>> getHistoryRenter(Connection connection, String SIN)
			throws SQLException { // useful to get SIN for comments
		...
		while (data.next()) {
			...
			entry.put("hostSIN", Integer.toString(host));
			entry.put("renterSIN", Integer.toString(renter));
			entry.put("listingID", Integer.toString(listing));
			entry.put("startDate", start.toString());
			entry.put("endDate", end.toString());
			result.add(entry);
		}
	...
	public static ArrayList<HashMap<String, String>> getHistoryHost(Connection connection, String SIN)
			throws SQLException { // useful to get SIN for comments
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
	...
	public static ArrayList<HashMap<String, String>> processResult(ResultSet r) throws SQLException {
		...
		while (r.next()) {
			...
			entry.put("hostSIN", r.getString("hostSIN"));
			entry.put("country", r.getString("country"));
			entry.put("address", r.getString("address"));
	...
	private static ArrayList<HashMap<String, String>> intersection(ArrayList<HashMap<String, String>> a,
		...
		for (HashMap<String, String> p : a) {
			for (HashMap<String, String> q : b) {
				...
				if (p.get("listingID").equals(q.get("listingID"))
						&& p.get("startDate").contentEquals(q.get("startDate"))
						&& p.get("endDate").equals(q.get("endDate"))) {
					set.add(p);
					break;
				}
			}
	...
	private static ArrayList<HashMap<String, String>> searchPostal(Connection connection,
			ArrayList<HashMap<String, String>> data, String postal) throws SQLException {
	...
	private static ArrayList<HashMap<String, String>> allAmenities(Connection connection, String query,
	...
	private static ArrayList<HashMap<String, String>> priceRange(Connection connection, double low, double high,
			ArrayList<HashMap<String, String>> data) throws SQLException {
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
	...
	private static ArrayList<HashMap<String, String>> closeListings(Connection connection, double setLat, double setLng,
			double distance, ArrayList<HashMap<String, String>> data) throws SQLException {
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
		query = "SELECT * FROM " + all + ";";
	...
	private static ArrayList<HashMap<String, String>> searchTime(Connection connection, Date start, Date end,
			ArrayList<HashMap<String, String>> data) throws SQLException {
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
	...
	private static ArrayList<HashMap<String, String>> specificAddress(Connection connection, String address,
			ArrayList<HashMap<String, String>> data) throws SQLException {
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
	...
	private static double calculateDistance(double setLat, double setLng, double eachLat, double eachLng) {
		...
		double a = Math.sin(latDistance / 2) * Math.sin(latDistance / 2) + Math.cos(Math.toRadians(setLat))
				* Math.cos(Math.toRadians(eachLat)) * Math.sin(lngDistance / 2) * Math.sin(lngDistance / 2);
	...
	public static ArrayList<HashMap<String, String>> hostListings(Connection connection, String SIN)
			throws SQLException {
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
		HashMap<String, String> entry = new HashMap<String, String>();
	...
	public static ArrayList<HashMap<String, String>> renterBookings(Connection connection, String SIN)
			throws SQLException {
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
		HashMap<String, String> entry = new HashMap<String, String>();
		String query = "Select * FROM listing, reservations WHERE renterSIN='" + SIN
				+ "' AND reservations.listingID=listing.listingID";
		ResultSet data = DBAPI.getDataByQuery(connection, query);
	...
	public static ArrayList<HashMap<String, String>> showCalendar(Connection connection, String listingID, String SIN)
			throws SQLException {
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
		HashMap<String, String> entry;
		query = "Select * FROM calendar,listing WHERE listing.listingID=calendar.listingID AND listing.listingID='"
				+ listingID + "' AND listing.hostSIN='" + SIN + "'";
	...
	public static ArrayList<HashMap<String, String>> reservationsToHost(Connection connection, String SIN)
			throws SQLException {
		ArrayList<HashMap<String, String>> result = new ArrayList<HashMap<String, String>>();
		HashMap<String, String> entry = new HashMap<String, String>();
