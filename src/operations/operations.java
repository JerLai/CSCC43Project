...
public class operations {
	...
	public static void createProfile(Connection connection, String SIN, String name, String address, String occupation,
	...
	public static void createProfile(Connection connection, String SIN, String name, String address, String occupation,
			String dob, String creditCard) throws SQLException {
		// This is for renter
		query = "INSERT INTO users(SIN, name, address, occupation, DoB) VALUES('" + SIN + "','" + name + "','" + address
				+ "','" + occupation + "','" + dob + "');";
		DBAPI.sendQuery(connection, query);
	...
	public static void createListing(Connection connection, String SIN, String types, String longitude, String latitude,
			String city, String country, String address, String postalCode) throws SQLException {

		query = "INSERT INTO listing(hostSIN, type, longitude, latitude, city, country, address, postalCode) VALUES('"
				+ SIN + "', '" + types + "', '" + longitude + "', '" + latitude + "', '" + city + "', '" + country
				+ "', '" + address + "', '" + postalCode + "');";
		DBAPI.sendQuery(connection, query);

	}

	private static boolean checkDates(Connection connection, String listingID, Date start, Date end)
			throws SQLException {
	...
	public static void createCalendar(Connection connection, String listingID, String startDate, String endDate,
			String price) throws SQLException {
		query = "INSERT INTO calendar(listingID, startDate, endDate, price) VALUES('" + listingID + "', '" + startDate
				+ "', '" + endDate + "', '" + price + "')";
		DBAPI.sendQuery(connection, query);
	}
	...
	public static void bookListing(Connection connection, String SIN, String listingID, Date start, Date end)
			throws SQLException {
		...
		while (data.next()) {
			...
			if (setStart.compareTo(start) < 0 && setEnd.compareTo(end) > 0
				...
				query = "INSERT INTO reservations(listingID, renterSIN, startDate, endDate, price) VALUES('" + listingID
						+ "','" + SIN + "','" + start.toString() + "','" + end.toString() + "', '" + price + "')";
				DBAPI.sendQuery(connection, query);

				query = "UPDATE calendar SET endDate='" + start + "'  WHERE startDate='" + setStart + "' AND listingID="
						+ listingID + ";";
				DBAPI.sendQuery(connection, query);

				query = "INSERT INTO calendar(listingID, startDate, endDate, price) VALUES('" + listingID + "','" + end
						+ "','" + setEnd + "','" + price + "');";
				DBAPI.sendQuery(connection, query);

				query = "INSERT INTO history(hostSIN, renterSIN, listingID, startDate, endDate) VALUES ('"
						+ Integer.toString(data.getInt("hostSIN")) + "', '" + SIN + "', '" + listingID + "', '"
						+ start.toString() + "', '" + end + "');";
				DBAPI.sendQuery(connection, query);
			...
			// start on date, end in middle
				...
				query = "UPDATE calendar SET startDate='" + end.toString() + "' WHERE startDate='" + setStart
				...
				query = "UPDATE calendar SET endDate='" + start.toString() + "' WHERE startDate='" + setStart
						+ "' AND listingID='" + listingID + "';";
				DBAPI.sendQuery(connection, query);
	...
	public static void addAmenity(Connection connection, String dining, String safety, String facilities, String guest,
			String logistics, String notIncluded, String bed, String outdoor, String basic, String listingID)
			throws SQLException {
		query = "INSERT INTO amenities(listingID, dining, safetyFeatures, facilities, guestAccess, logistics, notIncluded, bedAndBath, outdoor, basic) VALUES('"
				+ listingID + "','" + dining + "', '" + safety + "', '" + facilities + "', '" + guest + "', '"
				+ logistics + "', '" + notIncluded + "', '" + bed + "', '" + outdoor + "', '" + basic + "')";
		DBAPI.sendQuery(connection, query);
	}

	public static void hostRemoveListing(Connection connection, String listingID, Date start, Date end, String SIN,
			String hostSIN) throws SQLException {
		query = "DELETE FROM reservations WHERE listingID='" + listingID + "' AND startDate='" + start.toString()
				+ "' AND endDate='" + end.toString() + "' AND renterSIN='" + SIN + "';";
		DBAPI.sendQuery(connection, query);
		query = "DELETE FROM history WHERE hostSIN='" + hostSIN + "' AND listingID='" + listingID + "' AND startDate='"
				+ start.toString() + "' AND endDate='" + end.toString() + "' AND renterSIN='" + SIN + "';";
		DBAPI.sendQuery(connection, query);

		query = "INSERT INTO cancelled(hostSIN, listingID, startDate, endDate, renterSIN, hostCancel) VALUES ('"
				+ hostSIN + "', '" + listingID + "', '" + start.toString() + "', '" + end + "', '" + SIN + "', '1');";
		DBAPI.sendQuery(connection, query);
	}

	public static void renterRemoveListing(Connection connection, String listingID, Date start, Date end, String SIN,
			String hostSIN, double price) throws SQLException {
		query = "DELETE FROM reservations WHERE listingID='" + listingID + "' AND startDate='" + start.toString()
				+ "' AND endDate='" + end.toString() + "' AND renterSIN='" + SIN + "';";
		DBAPI.sendQuery(connection, query);
		query = "DELETE FROM history WHERE hostSIN='" + hostSIN + "' AND listingID='" + listingID + "' AND startDate='"
		...
		query = "INSERT INTO cancelled(hostSIN, listingID, startDate, endDate, renterSIN, hostCancel) VALUES ('"
				+ hostSIN + "', '" + listingID + "', '" + start.toString() + "', '" + end + "', '" + SIN + "', '0');";
		DBAPI.sendQuery(connection, query);
		...
		while (data.next()) {
			...
			if (setEnd.toString().equals(yesterday.toString()) && price == setPrice && set) {
				query = "UPDATE calendar SET startDate='" + setStart.toString() + "' WHERE listingID='" + listingID
						+ "' AND startDate='" + setStart.toString() + "';";
	...
	public static void updateTime(Connection connection, String listingID, Date start, Date end, Date newStart,
			Date newEnd) throws SQLException {
...
//		}
		...
		query = "UPDATE calendar SET startDate='" + newStart + "', endDate='" + newEnd + "' WHERE startDate='" + start
				+ "' AND endDate='" + end + "' AND listingID='" + listingID + "'";
		DBAPI.sendQuery(connection, query);
	}

	public static void addComment(Connection connection, String toSIN, String fromSIN, String message)
			throws SQLException {
	...
	public static void addRating(Connection connection, String SIN, String message, String rating, String listingID)
			throws SQLException {
	...
	public static void removeCalendar(Connection connection, String listingID, Date start, Date end)
			throws SQLException {

		query = "DELETE FROM calendar WHERE listingID='" + listingID + "' AND startDate='" + start.toString()
				+ "' AND endDate='" + end.toString() + "';";
		DBAPI.sendQuery(connection, query);
	}
